...
//   const blagsc=[{title:"item1 title"},{title:"item2 title"},{title:"item3 title"}]
//   return (
//    <div>
//     <h1> Name is aravind</h1>
//     <p id='para'>HI IAM SINGLE</p>
//     <img src='https://img.timesnownews.com/story/1542180014-Ajith.jpg_large.jpg?d=600x450' />
//     <ol  id='para'>
//       { blagsc.map((item,i) => {
